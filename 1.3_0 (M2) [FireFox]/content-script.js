...
async function init() {
  try {
    ...
    var b = new Promise(function(resolve, reject){
          browser.storage.local.get({"displayVideoBranding": true}, function(options){
    ...
    var d = new Promise(function(resolve, reject){
          browser.storage.local.get({"nextRatingRequest": 0}, function(options){
    ...
    console.log(`[Video Ads Blocker for Youtube™ v${browser.runtime.getManifest().version} Enabled]`);
    console.log(browser.i18n.getMessage("videoBranding") +`https://addons.mozilla.org/en-US/firefox/addon/video-ads-blocker-in-youtube-2/`)
...
function appendVideoIndicator(target) {
  ...
  anchor.href = `https://addons.mozilla.org/en-US/firefox/addon/video-ads-blocker-in-youtube-2/`;
  anchor.textContent = browser.i18n.getMessage("videoBranding");
  ...
  shareButton.onclick = (event) => {
    ...
    return navigator.share({
      ...
      url: `https://addons.mozilla.org/en-US/firefox/addon/video-ads-blocker-in-youtube-2/`,
    });
  };
...
function createRatingQuestion(videoCount) {
  ...
  reviewButton.href = `https://addons.mozilla.org/en-US/firefox/addon/video-ads-blocker-in-youtube-2/`;
  ...
  reviewButton.textContent = `❤️  ${browser.i18n.getMessage(
    "helpUsWithAReview"
  )}`;
  ...
  laterButton.textContent = `💨  ${browser.i18n.getMessage("later")}`;
  ...
  daaButton.textContent = `👎  ${browser.i18n.getMessage("dontAskAgain")}`;
